...
func ExecuteSQL(transaction *Transaction, sqlQuery string, args ...interface{}) (sql.Result, error) {
...
func ExecuteQuery(transaction *Transaction, sqlQuery string, args ...interface{}) (*sql.Rows, error) {
	if transaction.transaction != nil {
